...
function ReduxSagaFormUtils(api) {
    ...
    this.handleFormAction = /*#__PURE__*/_regenerator2.default.mark(function _callee4(url, callAction, action) {
        var result, error;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 9:
                        ...
                        error = new _reduxForm.SubmissionError(_context4.t0.response);


                        if (_context4.t0.response.non_field_errors) {
                            error = new _reduxForm.SubmissionError({ _error: _context4.t0.response.non_field_errors });
                        } else if (_context4.t0.response.message) {
                            error = new _reduxForm.SubmissionError({ _error: _context4.t0.response.message });
                        } else if (_context4.t0.response.detail) {
                            error = new _reduxForm.SubmissionError({ _error: _context4.t0.response.detail });
                        } else if (_context4.t0.response[0]) {
                            error = new _reduxForm.SubmissionError({ _error: _context4.t0.response[0] });
                        }
                        _context4.next = 15;
